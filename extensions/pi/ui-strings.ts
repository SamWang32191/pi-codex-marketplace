...
const zhTW = {
  ...
  'cmd.description': '於 Global Bridge Ledger 工作區管理 Codex Marketplace',
  'cmd.state.empty':
  ...
  'common.installation.none': 'Global 尚無 Installed Plugin。',
  'common.registration.none': 'Global 尚無 Marketplace Registration。',
  ...
  'ledger.section.observe.description': '檢視 Global 權威文件與衍生的 Effective State',
  ...
  'ledger.section.plugins.description': '相容候選與 Installation 狀態',
  ...
  'ledger.action.observe-authority': '檢視 Bridge State 權威文件',
  ...
  'ledger.rail.revision': 'State Revision {revision}',
  ...
  'ledger.row.registrationActions': 'Global Registration 操作',
  ...
  'ledger.row.retry.label': 'Global Pending Application',
  'ledger.row.retry.detail': '進行中的復原鏈 {receiptId} · State Revision {revision}',
  'ledger.row.observe.authority': 'Bridge State 權威文件',
  'ledger.row.observe.authorityDetail': 'Global State Revision {revision}',
  'ledger.row.observe.effective': 'Effective State 與 Projected Skills',
  'ledger.row.observe.effectiveDetail':
    'Registration {registrations} · Installation {installations}',
  'ledger.row.journal.label': 'Global Receipt Journal',
  'ledger.row.journal.detail': 'Receipt {receipts} · 進行中復原鏈 {chains} · 降級 {degraded}',
  'ledger.row.repair.label': 'Global State Repair',
  ...
  'ledger.status.browsing': '狀態：{section}｜{pane}',
  ...
  'life.removal.kind.registration': '整個 Registration（原子刪除其全部 Installations）',
  ...
  'life.removal.reg.intent': '原子移除此 Registration 與其全部 Installations',
  ...
  'life.removal.inst.intent': '僅移除此 Installation，保留其所屬 Registration',
  ...
  'life.removal.disclosure.cascade': '原子移除的 Installations：{count}',
  ...
  // --- journal.ts -----------------------------------------------------------------
  'journal.view.header': '=== Global Receipt Journal ===',
